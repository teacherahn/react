...
const StateEx02 = () => {
    ...
    // 화면 렌더링이 되지 않는다. (변수)
    // 화면 렌더링이 자동으로 된다. (useState는 자주 변경되는 데이터를 저장할 때 사용)
    ...
    return (
        ...
        <div>
            ...
            <p>
                일반 상태 업데이트:  <button>Increment</button>
            </p>
            <p> 
                함수형 상태 업데이트:  <button>Increment</button>
            </p>
            <p>
                인라인 상태 업데이트:<button>Increment</button>     
            </p>
            <p>
                변수 : <button>Increment</button>
            </p>
        </div>
